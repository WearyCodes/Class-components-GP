...
class App extends React.Component {
  ...
  toggleItem = itemId => {
  console.log(itemId)
  this.setState({groceries: this.state.groceries.map((grocery) => {if(grocery.id === itemId){
    return {...grocery, purchased: !grocery.purchased}
  }
return grocery})})
  }

  clearPurchased = () => {
    this.setState({groceries: this.state.groceries.filter(item => {
